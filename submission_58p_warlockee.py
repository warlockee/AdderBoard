"""
AdderBoard submission: 58-parameter trained transformer for 10-digit addition.
...
def build_model():
    ...
    metadata = {
        ...
        "tricks": [
            ...
            "Tied K=V",
            "Tied O=Q^T",
            "Tied QK norms (q_norm = k_norm, saves 4 params vs 62p)",
